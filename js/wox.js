...
$(function() {
    ...
    $(window).on("load", function() {
        ...
        $("a.logo.element-color-switch").addClass('logo-light');
    ...
    // 9. fullPage
    $("#fullpage").fullpage({
        anchors: ["home", "about", "services", "vip-service", "contact"],
        navigation: true,
        navigationPosition: "right",
        navigationTooltips: ["Home", "About", "Services", "Vip Service", "Contact"],
        responsiveWidth: 900,
        autoScrolling: true,
        scrollBar: false,
